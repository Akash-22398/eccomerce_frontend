...
import { faEdit, faSearch, faTrash, faTriangleExclamation } from "@fortawesome/free-solid-svg-icons";
...
const CategoryList = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                ...
                const response = await apiListPost('/category/list', data);
    ...
    // Define columns
    const columns = [
        { field: "id", headerName: "Category ID", width: 233, },
        { field: "name", headerName: "Category Name", width: 233 },
        {
            field: "image",
            headerName: "Image",
            width: 233,
