...
const AddProduct = () => {
            ...
            try {
                if (id) {
                    ...
                    if (response.success) {
                        ...
                        setSubCategory(response?.result?.subcategory._id)
                    }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let response;
            if (id) {
                response = await apiPut(`/product/${id}`, data);
            } else {
                response = await apiPost('/product', data);
            }
            if (response.success) {
                navigate('/products');
            }
            ...
            >
                <div className="flex flex-col sm:flex-row space-x-20">
                    ...
                    <div className="mb-4 input-container">
                        ...
                        />
                        <label htmlFor="Name" className="input-label"> Product Name <span className='text-red-500 w-full'>*</span></label>
                    ...
                    <div className="mb-4 input-container">
                        ...
                        <label htmlFor="Name" className="input-label"> Sub Category <span className='text-red-500 w-full'>*</span></label>
