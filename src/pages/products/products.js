...
const ProductsList = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                ...
                const response = await apiListPost('/product/list', data);
    ...
    // Define columns
    const columns = [
        { field: "id", headerName: "Category ID", width: 145, },
        { field: "name", headerName: "Product Name", width: 145 },
        { field: "name", headerName: "Sub Category Name", width: 145 },
        {
            field: "category",
            ...
            <div className="flex items-center justify-between w-full mb-4">
                <div className="flex flex-row w-[90%] item-center">
                    ...
                    <div className="flex flex-row items-center">
                        <img src="/liquidqube.png" alt="products" className="w-[20px] h-[20px] mr-4" />
